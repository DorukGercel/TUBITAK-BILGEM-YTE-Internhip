      ...
      return (
        <Dialog open={this.props.isOpen} onClose={this.props.onClose} aria-labelledby="form-dialog-title">
          ...
          <DialogActions>
            ...
            <Button onClick={() => {this.props.onSubmit(this.state.inputData); this.props.toggle();}} color="primary">
              Submit
            </Button>
          </DialogActions>
        </Dialog>
      ...
      return (
        <Dialog open={this.props.isOpen} onClose={this.props.onClose} aria-labelledby="form-dialog-title">
          ...
          <DialogActions>
            ...
            <Button onClick={() => {this.props.onSubmit(this.props.eventNo,this.state.inputData); this.props.toggle();}} color="primary">
              Submit
            </Button>
          </DialogActions>
        </Dialog>
